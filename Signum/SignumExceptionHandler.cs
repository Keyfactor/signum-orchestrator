...
{
    class SignumException : ApplicationException
    {
        public SignumException(string message) : base(message)
        { }

        public SignumException(string message, Exception ex) : base(message, ex)
        { }
